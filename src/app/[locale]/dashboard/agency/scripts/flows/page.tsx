...
export default function FlowsPage() {
  ...
  // Check if demo flows exist
  const hasDemoFlows = scripts.some((s) => s.name.startsWith("[DEMO]"));
          ...
          <div className="flex items-center gap-2">
            {hasDemoFlows ? (
              <button
                ...
                className="h-10 px-4 rounded-xl bg-red-600/20 text-red-400 font-medium flex items-center gap-2 hover:bg-red-600/30 transition-colors border border-red-500/30 disabled:opacity-50"
              >
                {deletingDemo ? (
              ...
              <button
                ...
                disabled={seeding}
                className="h-10 px-4 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium flex items-center gap-2 hover:from-purple-500 hover:to-pink-500 transition-colors disabled:opacity-50"
              >
                {seeding ? (
                  <Loader2 className="w-4 h-4 animate-spin" />
                ) : (
          ...
          <div className="bg-white/5 rounded-2xl p-12 border border-white/10 text-center">
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              <button
                onClick={handleSeedDemo}
                disabled={seeding}
                className="inline-flex h-10 px-6 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium items-center gap-2 hover:from-purple-500 hover:to-pink-500 transition-colors disabled:opacity-50"
              >
                {seeding ? (
                  <Loader2 className="w-4 h-4 animate-spin" />
                ) : (
                ...
                Générer flows de démo
              </button>
              <Link
                href={`/${locale}/dashboard/agency/scripts/new`}
                className="inline-flex h-10 px-6 rounded-xl bg-white/10 text-white font-medium items-center gap-2 hover:bg-white/20 transition-colors"
              >
                <Plus className="w-4 h-4" />
