...
// Wrapper component with Suspense for searchParams
export default function CreatorsPage() {
  return (
    <Suspense fallback={<CreatorsPageSkeleton />}>
      <CreatorsPageContent />
    </Suspense>
  );
}
...
function CreatorsPageContent() {
  ...
  // Get URL params for SEO-friendly filtering
  ...
  const setSortBy = (value: SortOption) => updateUrlParams("sort", value === "popular" ? null : value);
  const setSelectedCategory = (value: string | null) => updateUrlParams("category", value);
